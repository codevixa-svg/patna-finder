...
export default function AllBusinessesPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative text-white py-20 md:py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mb-3">
            Trending in <span className="text-[#F4B400]">Patna</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-6 sm:gap-8">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-[#F4B400]/20 rounded-lg flex items-center justify-center">
                <svg className="w-5 h-5 text-[#F4B400]" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-[#F4B400]/20 rounded-lg flex items-center justify-center">
                <svg className="w-5 h-5 text-[#F4B400]" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            ...
            <button
              ...
              className={`px-6 py-2.5 rounded-lg text-sm font-medium whitespace-nowrap flex items-center gap-2 transition ${
                openNow ? 'bg-[#0B3A63] text-white' : 'bg-gray-100 text-gray-700'
              }`}
            >
              {/* Toggle Icon */}
            ...
            <button
              ...
              className="px-6 py-2.5 bg-[#062B49] text-white rounded-lg text-sm font-medium whitespace-nowrap hover:bg-[#0a2448] flex items-center gap-2"
            >
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-[#D89E00]" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
            ...
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-full bg-[#0B3A63] text-white flex items-center justify-center hover:bg-[#062B49] transition"
      ...
      <section className="bg-gradient-to-r from-orange-50 to-[#FFF9E5] border-y border-orange-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <Link
              ...
              className="px-8 py-3 bg-[#F4B400] text-gray-900 font-bold rounded-lg hover:bg-[#D89E00] transition flex items-center gap-2 whitespace-nowrap"
            >
              Add Your Business
