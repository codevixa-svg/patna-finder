      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 lg:mb-8">
          <div className="bg-white rounded-xl p-4 sm:p-5 lg:p-6 shadow-sm border border-gray-200">
            ...
            <p className="text-xs sm:text-sm text-[#062B49] mt-1.5 sm:mt-2">
          ...
          <div className="bg-white rounded-xl p-4 sm:p-5 lg:p-6 shadow-sm border border-gray-200">
            <div className="flex items-center justify-between mb-3 sm:mb-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FFF4CC] rounded-lg flex items-center justify-center">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#B58200]" fill="currentColor" viewBox="0 0 20 20">
            ...
            <p className="text-xs sm:text-sm text-[#B58200] mt-1.5 sm:mt-2">
          ...
          <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              ...
              <Link
                ...
                className="p-3 sm:p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-[#0B3A63] hover:bg-[#FFF9E5] transition text-center group"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FFF4CC] rounded-lg flex items-center justify-center mx-auto mb-2 group-hover:scale-110 transition">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#062B49]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
