 ...
 * position. They use the site theme ([#F4B400] / navy text) and the same
...
export const CONTENT_BLOCKS: ContentBlockDef[] = [
  ...
  },
  {
    ...
    icon: '💡',
    html: '<div class="my-6 flex items-start gap-3 rounded-xl border-l-4 border-[#F4B400] bg-[#FFF9E5] p-4"><span class="shrink-0 text-lg">💡</span><div><p class="font-bold text-gray-900">Pro Tip</p><p class="mt-0.5 text-sm text-gray-600">Write your tip or note here…</p></div></div>',
  },
  {
    id: 'success-box',
    ...
    icon: '✅',
    html: '<div class="my-6 flex items-start gap-3 rounded-xl border-l-4 border-[#F4B400] bg-[#FFF9E5] p-4"><span class="shrink-0 text-lg">✅</span><div><p class="font-bold text-gray-900">Good to know</p><p class="mt-0.5 text-sm text-gray-600">Write your point here…</p></div></div>',
  },
  {
    id: 'warning-box',
    label: 'Warning Box',
  ...
  },
  {
    ...
    icon: '❝',
    html: '<blockquote class="my-6 rounded-r-xl border-l-4 border-[#F4B400] bg-[#FFF9E5] py-3 pl-4 pr-4 italic text-gray-700">“A memorable quote goes here…”<cite class="mt-2 block text-sm font-semibold not-italic text-gray-500">— Author Name</cite></blockquote>',
  },
  {
    id: 'key-facts',
    ...
    icon: '📋',
    html: '<div class="my-6 rounded-xl bg-[#FFF9E5] p-5"><p class="mb-2 font-bold text-gray-900">📋 Key Facts</p><ul class="list-disc space-y-1 pl-5 text-sm text-gray-700"><li>First interesting fact…</li><li>Second interesting fact…</li><li>Third interesting fact…</li></ul></div>',
  },
  {
    id: 'cta-card',
    label: 'CTA Card',
    ...
    icon: '📣',
    html: '<div class="my-8 rounded-2xl border-2 border-[#F4B400] bg-[#FFF9E5] p-6 text-center"><h3 class="text-xl font-bold text-gray-900">Ready to explore Patna?</h3><p class="mt-1 text-sm text-gray-600">Add a short line describing the action you want the reader to take.</p><a href="#" class="mt-4 inline-block rounded-lg bg-[#F4B400] px-6 py-2.5 text-sm font-semibold text-gray-900 hover:bg-[#D89E00]">Call to Action →</a></div>',
  },
  {
    id: 'faq-item',
    label: 'FAQ Item',
...
export const ARTICLE_TEMPLATES: ArticleTemplateDef[] = [
  ...
  },
  {
    ...
    icon: '🧭',
    html: '<p>Set the scene — where is this place and why should anyone visit?</p><h2>Overview</h2><p>Quick facts about the destination…</p><div class="my-6 flex items-start gap-3 rounded-xl border-l-4 border-[#F4B400] bg-[#FFF9E5] p-4"><span class="shrink-0 text-lg">💡</span><div><p class="font-bold text-gray-900">Best Time to Visit</p><p class="mt-0.5 text-sm text-gray-600">Season, timing and entry fee details…</p></div></div><h2>How to Reach</h2><p>Directions, nearest station, parking info…</p><h2>Things to Do</h2><ul class="list-disc pl-5"><li>Activity one…</li><li>Activity two…</li></ul><div class="my-8 rounded-2xl border-2 border-[#F4B400] bg-[#FFF9E5] p-6 text-center"><h3 class="text-xl font-bold text-gray-900">Plan your Patna trip now</h3><p class="mt-1 text-sm text-gray-600">Find hotels, food and more on Patna Finder.</p><a href="#" class="mt-4 inline-block rounded-lg bg-[#F4B400] px-6 py-2.5 text-sm font-semibold text-gray-900 hover:bg-[#D89E00]">Explore →</a></div>',
  },
  {
    id: 'food-review',
    label: 'Food Review',
    ...
    icon: '🍽️',
    html: '<p>Introduce the restaurant/café and what you ordered…</p><h2>What We Ordered</h2><p>Dish-by-dish experience…</p><div class="my-6 rounded-xl bg-[#FFF9E5] p-5"><p class="mb-2 font-bold text-gray-900">📋 Quick Facts</p><ul class="list-disc space-y-1 pl-5 text-sm text-gray-700"><li>Price for two: ₹…</li><li>Must try: …</li><li>Location: …</li></ul></div><h2>Verdict</h2><p>Final rating and recommendation…</p><blockquote class="my-6 rounded-r-xl border-l-4 border-[#F4B400] bg-[#FFF9E5] py-3 pl-4 pr-4 italic text-gray-700">“One line that captures the taste…”<cite class="mt-2 block text-sm font-semibold not-italic text-gray-500">— Patna Finder Review</cite></blockquote>',
  },
  {
    id: 'news-update',
    label: 'News / Update',
  ...
  },
  {
    ...
    icon: '🔢',
    html: '<p>Hook the reader — what makes this list worth reading…</p><h2>1. First Pick</h2><p>Why it deserves the spot…</p><h2>2. Second Pick</h2><p>Why it made the list…</p><h2>3. Third Pick</h2><p>What makes it special…</p><h2>4. Fourth Pick</h2><p>Details here…</p><h2>5. Fifth Pick</h2><p>Details here…</p><div class="my-6 rounded-xl bg-[#FFF9E5] p-5"><p class="mb-2 font-bold text-gray-900">📋 Quick Recap</p><ul class="list-disc space-y-1 pl-5 text-sm text-gray-700"><li>Best overall: …</li><li>Best budget: …</li></ul></div>',
  },
  {
    id: 'how-to-guide',
    label: 'How-To Guide',
